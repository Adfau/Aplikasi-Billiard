    ...
    public function deviceSet($device)
    {
        if ($this->_dState !== SERIAL_DEVICE_OPENED) {
            if ($this->_os === "linux") {
                ...
                if (preg_match("@^COM(\\d+):?$@i", $device, $matches) //@^COM(\\d+):?$@i @\bCOM(\d+)\b@i
                        and $this->_exec(
                    ...
                    // $this->_device = "\\.com" . $matches[1];
                    // trigger_error("This Device:" . $this->_device, E_USER_WARNING);
                    $this->_dState = SERIAL_DEVICE_SET;
...
// function serialSendMessage($message, $com = "COM1") {
//     $serial = new PhpSerial;
...
// function serialSetTable($table, $duration, $com = "COM3") {
//     $sendMsg = "set";
//     $sendMsg .= " " . $table;
//     $sendMsg .= " " . $duration;
//     serialSendMessage($sendMsg, $com);
// }

// function serialStopTable($table, $com = "COM3") {
//     $sendMsg = "stop";
//     $sendMsg .= " " . $table;
//     serialSendMessage($sendMsg, $com);
// }

// function serialUpdateTable($oldTable, $newTable, $com = "COM3") {
//     $sendMsg = "move";
//     $sendMsg .= " " . $oldTable;
//     $sendMsg .= " " . $newTable;
//     serialSendMessage($sendMsg, $com);
